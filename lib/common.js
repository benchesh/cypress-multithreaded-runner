...
exports.getFullConfig = (config) => {
    ...
    fullConfig.reportDir = fullConfig.reportDir ? path.resolve(fullConfig.reportDir) : '';
    ...
    fullConfig.allureReportHeadingFinal = `Cypress Multithreaded Runner${fullConfig.allureReportHeading ? `: ${fullConfig.allureReportHeading}` : ''}`;
