...
const { argv } = yargs(hideBin(process.argv))
    ...
    .alias('runFailedSpecFilesFromReportUrl', 'runFailedSpecFilesFromReportURL')
    .alias('runFailedSpecsFromReportURL', 'runFailedSpecFilesFromReportURL')
    .alias('runFailedSpecsFromReportUrl', 'runFailedSpecFilesFromReportURL')
    .alias('runFailsFromReportURL', 'runFailedSpecFilesFromReportURL')
    .alias('runFailsFromReportUrl', 'runFailedSpecFilesFromReportURL')
    .alias('runFailedFromReportURL', 'runFailedSpecFilesFromReportURL')
    .alias('runFailedFromReportUrl', 'runFailedSpecFilesFromReportURL')
...
exports.getFullConfig = (config) => {
    ...
    fullConfig.reportDir = fullConfig.reportDir ? path.join(fullConfig.reportDir) : null;
