...
| `onlyRunSpecFilesIncludingAnyText` | oneOfType(string, arrayOf(string)) | null                        | Only run spec files in each Cypress thread if ANY of the strings in the given array are found within the spec file. If a single string is provided instead of an array, the entire string must be found. See [here](#using-grep-in-conjunction-with-onlyrunspecfilesincludinganytext-and-onlyrunspecfilesincludingalltext) for more information                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| `onlyRunSpecFilesIncludingAllText` | oneOfType(string, arrayOf(string)) | null                        | Only run spec files in each Cypress thread if ALL of the strings in the given array are found within the spec file. See [here](#using-grep-in-conjunction-with-onlyrunspecfilesincludinganytext-and-onlyrunspecfilesincludingalltext) for more information                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
...
| `singleThread`                     | boolean                            | false                       | Collate all Cypress tasks into a single thread. May prove useful should you wish to run just a single test using `grep` / `onlyRunSpecFilesIncludingAnyText` / `onlyRunSpecFilesIncludingAllText`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
