...
| `timeout`               | number  | 60            | The maximum amount of time to wait for in seconds. The threads will begin when the time elapses, regardless of whether the file exists or not.                                                                         |
